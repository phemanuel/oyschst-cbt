        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile">
            <a class="nav-link">
              ...
              <!-- <p class="bold-text-font">{{ $studentData->surname }} {{ $studentData->first_name }} {{ $studentData->last_name }}</p> -->
              </div>
                  ...
                  <ul class="d-flex flex-column-reverse todo-list">
                    ...
                    <li>
                      <tr>
                              ...
                              <td><strong><p class="bold-font">{{ $studentData->surname }} {{ $studentData->first_name }} {{ $studentData->last_name }} </p></strong></td>
