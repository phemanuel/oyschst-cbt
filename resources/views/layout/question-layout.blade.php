            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                    ...
                    @endif
                    <td> <a class="label label-primary" href="{{route('question-edit.action', ['id' => $rs->id])}}">Edit</a>
                    <a class="label label-danger" href="{{route('question-delete.action', ['id' => $rs->id])}}">Delete</a>                    
                </td>
                </tr>
                @endforeach
                @else
