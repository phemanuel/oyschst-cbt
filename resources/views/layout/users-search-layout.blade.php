...
<tr>           
                      <th>&nbsp;</th> 
                        <th>&nbsp;</th>
                        <th>&nbsp;</th>
                        <th colspan="16"><div align="center" class="bold-font">Roles and Permission</div></th>
                        <th>&nbsp;</th>
                        <th colspan="2">&nbsp;</th>
                        <th>&nbsp;</th>
                      </tr>
                      ...
                      <th>ID</th> 
                        <th>Admin Name</th>
                        <th>Email Address</th>
                        <th colspan="2">Exam Setting</th>
                        <th colspan="2">Question Bank</th>
                        <th colspan="2">Student List/Upload</th>
                        <th colspan="2">Student Login/Exam Status</th>
                        <th colspan="2">Change Course</th>
                        <th colspan="2">Create Admin User</th>
                        <th colspan="2">College Setup</th>
			...
			@foreach ($users as $key => $rd)
                      <tr> 
                        ...
                        <td>Access Module</td>
                        <td>@if($rd->qst_bank == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->qst_bank == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                        <td>@if($rd->std_list == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->std_list == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                        <td>@if($rd->std_login_status == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->std_login_status == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                        <td>@if($rd->change_course == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->change_course == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                        <td>@if($rd->user_create == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->user_create == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                        <td>@if($rd->college_setup== 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->college_setup == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Access Module</td>
                      ...
                      <tr>
                        ...
                        <td>Create</td>
                        <td>@if($rd->create_question_bank == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->create_question_bank == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Create</td>
                        <td>@if($rd->create_std_list == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->create_std_list == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Edit</td>
                        <td>@if($rd->edit_std_login_status == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_std_login_status == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Edit</td>
                        <td>@if($rd->edit_change_course == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_change_course == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Create</td>
                        <td>@if($rd->create_user_create == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->create_user_create == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Create</td>
                        <td>@if($rd->create_college_setup== 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->create_college_setup == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Check Result</td>
                        <td>@if($rd->check_report == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->check_report == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>Edit</td>
                        <td>@if($rd->edit_question_bank == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_question_bank == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Edit</td>
                        <td>@if($rd->edit_std_list == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_std_list == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>Edit</td>
                        <td>@if($rd->edit_user_create == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_user_create == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Edit</td>
                        <td>@if($rd->edit_college_setup== 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->edit_college_setup == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>Export Result</td>
                        <td>@if($rd->export_report == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->export_report == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        ...
                        <td>&nbsp;</td>
                        <td>Delete</td>
                        <td>@if($rd->delete_std_list == 1) <img src="{{asset('dashboard/dist/img/success.png')}}" alt="" width="18" height="18" /> @elseif($rd->delete_std_list == 0) <img src="{{asset('dashboard/dist/img/failed.png')}}" alt="" width="18" height="18" /> @endif </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
		...
		@else
		<tr>
			<td colspan="23">Users not available.</td>
        </tr>
		@endif                                   
                    </table>
                    {{ $users->links() }}
