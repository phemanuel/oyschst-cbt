...
class CbtEvaluation2 extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'cbtevaluation2';
     ...
     */
    protected $fillable = [
        'examid', 'examstatus', 'studentname', 'correct', 'noofquestion', 'wrong', 'studentno', 'subject1', 
        'score', 'date1', 'username', 'grade', 'class', 'session1', 'term', 'parentphoneno', 'percentage', 
        'partno', 'credits', 'timein', 'timeout', 'hour', 'minute', 'qstno',
        ...
        'department', 'pageno', 'subject2', 'subject3', 'subject4', 'subject5', 'score1', 'score2', 'score3',
         'score4', 'score5', 'examdate', 'examdate1', 'examtype', 'msgstatus', 'starttime', 'endtime'
    ];
}
