...
class ReportController extends Controller
{
    ...
    public function examSheetPage1($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
        ...
        //---Qst1
        if($examViewType == 'Single-Page'){
            $question1 = QuestionSingle::where('session1', $qstData->session1)
                    ->where('department', $qstData->department)
                    ->where('level', $qstData->level)
                    ->where('course', $qstData->course)
                    ->where('exam_mode', $qstData->exam_mode)
        ...
        //---Qst2
        $question2 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst3
        $question3 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst4
        $question4 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst5
        $question5 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst6
        $question6 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst7
        $question7 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst8
        $question8 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst9
        $question9 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
        ...
        ->first();   
        //---Qst10
        $question10 = QuestionSingle::where('session1', $qstData->session1)
        ->where('department', $qstData->department)
        ->where('level', $qstData->level)
        ->where('course', $qstData->course)
        ->where('exam_mode', $qstData->exam_mode)
    ...
    'studentAnswer', 'correctAnswer','qstData', 'noOfQst','examViewType'));
        }
        elseif($examViewType == 'Multi-Page'){
    ...
    public function examSheetPage2($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage3($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage4($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage5($examViewType , $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage6($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage7($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage8($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage9($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage10($examViewType, $id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function studentReport($id)   
    {
        ...
        // Join TheoryAnswer with StudentAdmission to get picturename
        $student = CbtEvaluation::where('cbt_evaluations.studentno', $studentData->admission_no) 
        ->where('examstatus', 2)
        ->join('student_admissions', 'cbt_evaluations.studentno', '=', 'student_admissions.admission_no')
        ->select('cbt_evaluations.*', 'student_admissions.picture_name', 'student_admissions.state',
        'student_admissions.department1')
        ...
        return view('student.pages.student-report', compact('softwareVersion','collegeSetup',
        'student','studentData'));
    }
    
    public function examSheetPage01($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
        ...
        // Retrieve shuffled question numbers from CbtEvaluation model
        $qstData = CbtEvaluation::where('id', $id)->first();
		$studentData = StudentAdmission::where('admission_no', $qstData->studentno)
                        //->where('department', $department)
                        ->first();
		$questionSetting = QuestionSetting::where('department', $qstData->department)
		->where('course', $qstData->course)
		->where('level' , $qstData->level)
		->where('semester', $qstData->semester)
		->where('session1', $qstData->session1)
        ...
        return view('student.pages.exam-sheet', compact('pageNo', 'collegeSetup', 'softwareVersion',
        'questionNo', 'question1','question2', 'question3', 'question4', 'question5', 'question6'
        , 'question7', 'question8', 'question9', 'question10', 'studentAnswerData', 'correctAnswerData',
    'studentAnswer', 'correctAnswer','qstData', 'noOfQst','examViewType','studentData'));
        }
        elseif($examViewType == 'Multi-Page'){
            $question1 = Question::where('session1', $qstData->session1)
                    ->where('department', $qstData->department)
    ...
    public function examSheetPage02($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage03($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage04($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage05($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage06($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage07($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage08($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage09($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
    ...
    public function examSheetPage010($id)
    {
        $collegeSetup = CollegeSetup::first();
        $softwareVersion = SoftwareVersion::first(); 
