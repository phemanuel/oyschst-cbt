...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2024 at 09:37 AM
...
CREATE TABLE `cbt_evaluation1` (
  ...
  `parentphoneno` text DEFAULT NULL,
  ...
  `OK1` int(11) DEFAULT NULL,
  `OK2` int(11) DEFAULT NULL,
  `OK3` int(11) DEFAULT NULL,
  `OK4` int(11) DEFAULT NULL,
  `OK5` int(11) DEFAULT NULL,
  `OK6` int(11) DEFAULT NULL,
  `OK7` int(11) DEFAULT NULL,
  `OK8` int(11) DEFAULT NULL,
  `OK9` int(11) DEFAULT NULL,
  `OK10` int(11) DEFAULT NULL,
  `OK11` int(11) DEFAULT NULL,
  `OK12` int(11) DEFAULT NULL,
  `OK13` int(11) DEFAULT NULL,
  `OK14` int(11) DEFAULT NULL,
  `OK15` int(11) DEFAULT NULL,
  `OK16` int(11) DEFAULT NULL,
  `OK17` int(11) DEFAULT NULL,
  `OK18` int(11) DEFAULT NULL,
  `OK19` int(11) DEFAULT NULL,
  `OK20` int(11) DEFAULT NULL,
  `OK21` int(11) DEFAULT NULL,
  `OK22` int(11) DEFAULT NULL,
  `OK23` int(11) DEFAULT NULL,
  `OK24` int(11) DEFAULT NULL,
  `OK25` int(11) DEFAULT NULL,
  `OK26` int(11) DEFAULT NULL,
  `OK27` int(11) DEFAULT NULL,
  `OK28` int(11) DEFAULT NULL,
  `OK29` int(11) DEFAULT NULL,
  `OK30` int(11) DEFAULT NULL,
  `OK31` int(11) DEFAULT NULL,
  `OK32` int(11) DEFAULT NULL,
  `OK33` int(11) DEFAULT NULL,
  `OK34` int(11) DEFAULT NULL,
  `OK35` int(11) DEFAULT NULL,
  `OK36` int(11) DEFAULT NULL,
  `OK37` int(11) DEFAULT NULL,
  `OK38` int(11) DEFAULT NULL,
  `OK39` int(11) DEFAULT NULL,
  `OK40` int(11) DEFAULT NULL,
  `OK41` int(11) DEFAULT NULL,
  `OK42` int(11) DEFAULT NULL,
  `OK43` int(11) DEFAULT NULL,
  `OK44` int(11) DEFAULT NULL,
  `OK45` int(11) DEFAULT NULL,
  `OK46` int(11) DEFAULT NULL,
  `OK47` int(11) DEFAULT NULL,
  `OK48` int(11) DEFAULT NULL,
  `OK49` int(11) DEFAULT NULL,
  `OK50` int(11) DEFAULT NULL,
  `OK51` int(11) DEFAULT NULL,
  `OK52` int(11) DEFAULT NULL,
  `OK53` int(11) DEFAULT NULL,
  `OK54` int(11) DEFAULT NULL,
  `OK55` int(11) DEFAULT NULL,
  `OK56` int(11) DEFAULT NULL,
  `OK57` int(11) DEFAULT NULL,
  `OK58` int(11) DEFAULT NULL,
  `OK59` int(11) DEFAULT NULL,
  `OK60` int(11) DEFAULT NULL,
  `OK61` int(11) DEFAULT NULL,
  `OK62` int(11) DEFAULT NULL,
  `OK63` int(11) DEFAULT NULL,
  `OK64` int(11) DEFAULT NULL,
  `OK65` int(11) DEFAULT NULL,
  `OK66` int(11) DEFAULT NULL,
  `OK67` int(11) DEFAULT NULL,
  `OK68` int(11) DEFAULT NULL,
  `OK69` int(11) DEFAULT NULL,
  `OK70` int(11) DEFAULT NULL,
  `OK71` int(11) DEFAULT NULL,
  `OK72` int(11) DEFAULT NULL,
  `OK73` int(11) DEFAULT NULL,
  `OK74` int(11) DEFAULT NULL,
  `OK75` int(11) DEFAULT NULL,
  `OK76` int(11) DEFAULT NULL,
  `OK77` int(11) DEFAULT NULL,
  `OK78` int(11) DEFAULT NULL,
  `OK79` int(11) DEFAULT NULL,
  `OK80` int(11) DEFAULT NULL,
  `OK81` int(11) DEFAULT NULL,
  `OK82` int(11) DEFAULT NULL,
  `OK83` int(11) DEFAULT NULL,
  `OK84` int(11) DEFAULT NULL,
  `OK85` int(11) DEFAULT NULL,
  `OK86` int(11) DEFAULT NULL,
  `OK87` int(11) DEFAULT NULL,
  `OK88` int(11) DEFAULT NULL,
  `OK89` int(11) DEFAULT NULL,
  `OK90` int(11) DEFAULT NULL,
  `OK91` int(11) DEFAULT NULL,
  `OK92` int(11) DEFAULT NULL,
  `OK93` int(11) DEFAULT NULL,
  `OK94` int(11) DEFAULT NULL,
  `OK95` int(11) DEFAULT NULL,
  `OK96` int(11) DEFAULT NULL,
  `OK97` int(11) DEFAULT NULL,
  `OK98` int(11) DEFAULT NULL,
  `OK99` int(11) DEFAULT NULL,
  `OK100` int(11) DEFAULT NULL,
  ...
  `score3` text DEFAULT NULL,
  `score4` text DEFAULT NULL,
  `score5` text DEFAULT NULL,
  `examdate` text DEFAULT NULL,
  `examdate1` text DEFAULT NULL,
...
(1, '100', 'ENTRANCE', '2024/2025', 'First', 'Certificate for Pharmacy Technicians', 'ENTRANCE', 'GENERAL', 'OBJECTIVE', 5, 20, 20, 0, '2024-05-01 19:33:35', '2024-05-14 02:05:37');
...
(102, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 1, 'Itemize  the levels of classification of living thing in correct sequence.\n(A) kingdom, phylum, class, family, order, genus, species\n(B). Kingdom, phylum, class, order, family, specie, genus\n(C). Kingdom, phylum, class, order, family, genus, specie\n(D) Kingdom, phylum, class, order, genus, family, specie', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(103, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 2, 'At the end of meosis, the parent cell produce??daughter cell\n(A) 5\n(B)2\n(C) 4\n(D) 6', 'C', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(104, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 3, 'Mention the stages involve in the process of mitosis.\n(A). Interphase, prophase, metaphase, anaphase, telophase.\n(B). Prophase, interphase, telophase, metaphase, anaphase\n(C). Interphase, prophase, telophase, metaphase, anaphase\n(D). Telophase, interphase, prophase, metaphase, anaphase', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(105, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 4, 'The process of photosynthesis starts in the????????????????????????and the??????????????????????????????of the chloroplast\n(A). Stroma and thylakoid\n(B). Thylakoid and stroma\n(C). cytoplasm and mitochondria\n(D). Thylakoid and cytoplasm', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(106, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 5, 'During????????????????????stage of mitosis the chromosome arrange themselves at the equator on the spindle fibre at a point called centromere.\n(A) metaphase\n(B) Anaphase(C ) prophase\n(D)  telophase', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(107, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 6, 'A cell is the basic unit of a living things because it can carry out all life activities. The following are life activities performed by a cell, except?????????????????????\n(A) Reproduction\n(B) Excretion\n(C) Digestion\n(D) Mileage', 'D', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(108, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 7, '????????????????????????????????????????and???????????????????????????????????are among the renowned scientist who worked on revealing the existence of cell.\n(A) Robert Hooke, Ivan Pavlov\n(B) Mattias Scledien, Robert Hooke.\n(C) Mattias Scledien, Felix Hooke\n(D) Mattias Scledien, Robert Hooke', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(109, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 8, 'Computer deals with two major things\n(A) Memory and Location\n(B) Process and Address\n(C ) Data and Instruction\n(D) Power and Data', 'C', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(110, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 9, 'Parenchyma, collenchyma, xylem, phloem cells are examples of ??????????????????????????????.\n(A) Animal cell\n(B) Plants cell\n(C) mitosis\n(D) meiosis', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(111, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 10, 'Cell division is considered as reproduction to ??????????????????????????????????????organism and as growth to???????????????????????????organism.\n(A) Multicellular, unicellular\n(B) Unicellular, Multicellular(C) mitosis, meosis\n(D) meosis, muiticellular', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(112, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 11, 'The first group of people in the world that started speaking French is.........\n(A) Francois\n(B)Le Gaule\n(C)Le Faule\n(D) Le Francois.', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(113, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 12, 'French language was introduced in Nigeria in the year ??\n(A)1951 (B)1961 (C)1959\n(D)1969', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(114, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 13, 'The SD card is not a primary memory because\n(A) It is not useful in the process of booting\n(B) It uses RAM technology\n(C ) It has low storage capacity\n(D) It is a removable storage device', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(115, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 14, 'C\'est          Stylo.\n(A)un\n(B)de\n(C)des\n(D)une', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(116, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 15, 'The concept of miniaturization was first introduced in the ?????????????????????????generation of computer\n(A) First Generation\n(B) Second Generation(C ) Third Generation\n(D) Fourth Generation', 'C', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(117, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 16, 'Which of the following memory device is prominent in old computers\n(A)  CD Card\n(B) Flash Drive (C ) Floppy Drive\n(D) BIOS', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(118, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 17, 'Another word for:  \"A toute a l\'heure\" is:.......... (A)Abientot\n(B)Abien tot\n(C)A bientot\n(D) A biento', 'C', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(119, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 18, 'How do we great a birthday celebrant in French?.......\n(A) Bonne anniverssaire\n(B)Bon anniversaire\n(C) Bonne anniversaire\n(D)Bon anniversary', 'B', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(120, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 19, '???????????????????????????is the electronic board that serve as template for connection of other peripheral components of the computer\n(A)  Motherboard\n(B) System Clock (C ) CMOS\n(D) Local Disk', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50'),
(121, '2024/2025', 'Diploma in Community Health(CHEW)', '100', 'ENTRANCE', 'ENTRANCE', 'OBJECTIVE', 'GENERAL', 20, 20, 'text', 20, '?... garcon est beau\n(A)Le\n(B) L\' (C)La(D)Les', 'A', 'blank.jpg', '2024-05-14 02:03:50', '2024-05-14 02:03:50');
...
(18, '2024/2025', 'Certificate for Pharmacy Technicians', 'ENTRANCE', 20, '100', 20, 'ENTRANCE', 'GENERAL', 'Active', 'OBJECTIVE', '2024-06-03', 0, '2024-05-14 01:38:44', '2024-05-14 02:05:37'),
(20, '2024/2025', 'Diploma in Community Health(CHEW)', 'ENTRANCE', 20, '100', 20, 'ENTRANCE', 'GENERAL', 'Inactive', 'OBJECTIVE', '2024-06-05', 1, '2024-05-14 02:03:50', '2024-05-14 02:05:37');
...
(1, 'Admin CBT', 'admin@gmail.com', 1, NULL, '$2y$12$ZnTRyBs.WISiLa5h/2lwxu3.zl1UR6I8Jn8DftqX4I3swyQIHBQS2', NULL, 0, '2024-05-09 19:19:26', '2024-05-09 19:19:26'),
